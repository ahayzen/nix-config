...
{ config, lib, pkgs, ... }:
{
  ...
  systemd = {
    ...
    services."docker-compose-runner".after = [ "mnt-mapping\\x2dpool\\x2duser1000.mount" ];
    services."docker-compose-runner".requires = [ "mnt-mapping\\x2dpool\\x2duser1000.mount" ];
  };
