...
let
  ...
  # Users
  user = {
    desktop-scan-2017-kdab-andrew-kdab = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIIuMYUGh7pv6bvnNF75zPkc3E7ZvFvNIYl52vo+UUz2 andrew@desktop-scan-2017-kdab";
...
in
{
  ...
  group = {
    ...
    users = {
      developer = [
        user.desktop-scan-2017-kdab-andrew-kdab
