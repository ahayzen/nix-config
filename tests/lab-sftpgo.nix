...
(import ./lib.nix) {
  ...
  nodes = {
    vps = { self, pkgs, ... }: {
      ...
      networking.hosts = {
        "127.0.0.1" = [ "actual.ahayzen.com" "bitwarden.hayzen.uk" "immich.ahayzen.com" "home.hayzen.uk" "sftpgo.hayzen.uk" "webdav.hayzen.uk" "ahayzen.com" "yumekasaito.com" ];
      };
    ...
    lab = { self, pkgs, ... }: {
      ...
      networking.hosts = {
        ...
        "192.168.1.3" = [ "actual.ahayzen.com" "bitwarden.hayzen.uk" "immich.ahayzen.com" "home.hayzen.uk" "sftpgo.hayzen.uk" "webdav.hayzen.uk" "ahayzen.com" "yumekasaito.com" ];
      };
